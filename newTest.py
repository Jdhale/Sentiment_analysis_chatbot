...
#         """Load a pre-trained BERT model for Indic languages"""
#         try:
...
#                 model_name, 
#                 num_labels=8,  # Adjust based on your emotion classes
...
#                         st.markdown(f"**Validation samples**: {len(valid_df)}")
#                         st.markdown(f"**Test samples**: {len(test_df)}")
...
#             if len(st.session_state.processor.train_df or []) == 0:
...
#         # Quick stats
#         if hasattr(st.session_state.processor, 'train_df') and st.session_state.processor.train_df is not None:
#             st.markdown("### 📊 Dataset Stats")
#             st.metric("Training Samples", len(st.session_state.processor.train_df))
#             if st.session_state.processor.valid_df is not None:
#                 st.metric("Validation Samples", len(st.session_state.processor.valid_df))
#             if st.session_state.processor.test_df is not None:
